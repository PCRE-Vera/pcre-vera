...
The lockstep matcher adds one side condition to the two the backtracking
...
theorem pikeRun_refinesMatches {p : Pat} {s : ByteArray} {start : Nat}
  ...
  pikeRun_refines_matches p s start mo lim init hw hs hpike
...
theorem exec_refines_pike_wf {p : Pat} {s : ByteArray} {start : Nat}
  ...
  exec_refines_pike hv hs (pikeRun_refinesMatches hw hs hpike)
...
theorem exec_pike_found {p : Pat} {s : ByteArray} {start : Nat}
  ...
  (exec_refines_pike_wf hv hw hs hpike).1 hout
...
theorem exec_pike_notFound {p : Pat} {s : ByteArray} {start : Nat}
  ...
  (exec_refines_pike_wf hv hw hs hpike).2.1 hout
...
theorem matchers_agree_wf {p : Pat} {s : ByteArray} {start : Nat} {mo : MOpts}
  ...
  matchers_agree hvP hvB hs (pikeRun_refinesMatches hw hs hpike)
    (btRun_refinesMatches hw hs) hneP hneB
